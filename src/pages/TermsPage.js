        ...
        return (
            <div className="TermsPage">
                ...
                <div className="body">
                    ...
                    <p>Thank you for downloading the Ask Izzy application ( <strong>App</strong> ), which is operated by Infoxchange (ABN 74 457 506 140). Access to, and use of, this App is provided strictly subject to these terms of use. By downloading and using this App, you accept these terms of use and our <a href="https://www.infoxchange.net.au/privacy-policy">Privacy Policy</a> (collectively the <strong>App Terms</strong> ). Please only download and use this App if you have read, understood and agree to these terms of use.</p>
                    ...
                    <p>Infoxchange reserves the right to add to, change or discontinue the services, programs and information contained in, or any other aspect of, this App at any time and without liability. Please check the [<strong>please insert where users can check for updates</strong>] regularly for changes proposed by Infoxchange to these App Terms as your continued use of this App will signify your acceptance of any proposed changed App Terms. Please uninstall the App if you do not agree to any changes to the App Terms.</p>
