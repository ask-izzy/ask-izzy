    ...
    render() {
        return (
            <StaticPage title="Food Banks">
                ...
                <li><Link to="/category/food/in/Brisbane-QLD">Food banks in Brisbane</Link></li>
                <li><Link to="/category/food/in/Canberra-ACT">Food banks in Canberra</Link></li>
                <li><Link to="/category/food/in/Darwin-NT">Food banks in Darwin</Link></li>
                <li><Link to="/category/food/in/Melbourne-VIC">Food banks in Melbourne</Link></li>
                <li><Link to="/category/food/in/Perth-WA">Food banks in Perth</Link></li>
                <li><Link to="/category/food/in/Sydney-NSW">Food banks in Sydney</Link></li>
                </ul>
            </StaticPage>
        );
    }
