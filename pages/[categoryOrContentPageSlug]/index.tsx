...
type Props = {
    categoryKey?: string,
    contentPage?: Record<string, any>, // Apollo doesn't generate types from the specified
...
export const getStaticProps: GetStaticProps<Props> = async({params}) => {
    const category = getCategory(params?.categoryOrContentPageSlug as string)
    if (category) {
        return {
            props: {
...
export default function CategoryOrContentPage(props: Props) {
