...
```bash
# Contents of .env
ISS3_BASE_URL="https://<iss domain>"
ISS3_API_KEY="<username>:<token>"
...
```bash
ENVIRONMENT="dev_local" NODE_ENV="development" ISS3_BASE_URL="$ISS3_BASE_URL" ISS3_API_KEY="$ISS3_API_KEY" GOOGLE_API_KEY="$G_API_KEY" ./script/dev-server
```
